<?
        ...
        * @author yedincisenol | Ýbrahim Þ. Örencik | github.com/yedincisenol
        */
       class yedTarih{
           var $gunler=array(
		...
		function ver($donem='tarih'){
            ...
            * $format deðiþkenine verilebilecek deðerler: uzun,ideal,kisa,noktali,saatli,saatliGunlu,gun
            * @return string
            */
		function formatla($tarih,$format='ideal'){
               ...
               $yeniTarih['noktali']=$gun.'.'.$ay.'.'.$yil; #Örn: 20.12.2010
               $yeniTarih['saatli']=$gun.' '.$this->aylar[$this->dil][$ay].' '.$yil.', '.$saat.':'.$dakika;
               $yeniTarih['saatliGunlu']=$gun.' '.$this->aylar[$this->dil][$ay].' '.$yil.', '. $gunAdi.'  '.$saat.':'.$dakika; # 30 Mayýs 2013, Perþembe 10:35
